...
$str = file_get_contents("rods://demouser:demopass@srbbrick15.sdsc.edu:1247/tempZone/home/demouser/test.txt");
var_dump($str);

// print the children of home dir "/tempZone/home/demouser"
$children = scandir("rods://demouser:demopass@srbbrick15.sdsc.edu:1247/tempZone/home/demouser");
var_dump($children);
?>
