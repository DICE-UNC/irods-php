 ...
 */
Ext.tree.RODSTreeLoader = function(config){
    this.baseParams = {};
...
Ext.extend(Ext.tree.RODSTreeLoader, Ext.util.Observable, {
    uiProviders : {},
    clearOnLoad : true,
    ...
    getParams: function(node){
        ...
        if (node.getDepth()==0)
          buf.push("recursive=", encodeURIComponent(1), "&");
        buf.push("node=", encodeURIComponent(node.getPath()));
